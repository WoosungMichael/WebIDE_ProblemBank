...
import DetailTestsLayout from '../../../../layouts/DetailTestsLayout';
var moment = require('moment');

function DetailTests(props) {
    ...
    useEffect(() => {
        if(problemsAllData){
            ...
            dispatch(getTestData()).then(response => {
    ...
    return (
        <DetailTestsLayout>
            <div className="tests__detail">
                <div className="tests__detail--content">
                ...
                <div className="tests__detail--vseditor">
